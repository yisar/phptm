...
<?php
	if (count($threads)==0) {
		echo '<div style="padding:20px 0;text-align: center;font-size: 20px;">你还没有发起过任何讨论。</div>';
	} else {
		echo '<div style="padding:20px 0;text-align: center;font-size: 20px;">由 '.$_SESSION['username'].' 发起的讨论</div>';
	}
