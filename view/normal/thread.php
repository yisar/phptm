...
<span class="link-normal">[<a class="link" href="view.php?tid=0&reply=%3e%3e<?php echo $t['tid']?>">举报</a>]</span>
...
<?php } ?>
<span class="link-rep">[<a class="link" target="_blank" href="view.php?id=<?php echo $t['tid'],'&reply=%3e%3e',$t['tid'];?>#reply">回应</a>]</span>
